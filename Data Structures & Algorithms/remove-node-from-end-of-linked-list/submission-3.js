...
class Solution {
    ...
    removeNthFromEnd(head, n) {
        ...
        // prev holding |2| 1
        let reversed = prev; // save the head ptr of reversed list in prehand
        ...
        if (n === 1) reversed = prev.next; // ONLY on first from the end removal case
        prev.next = null; // isolate the nth node
