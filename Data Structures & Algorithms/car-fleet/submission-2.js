class Solution {
    ...
    carFleet(target, position, speed) {
        ...
        // ** can use stack to manage "groups"
            // each "group's" representative will have an index within a stack.
        // ** when the problem gives us some numbers and there are things we can
        // easily calculate, utilize those - its basically a free hint
        // ** focus on "what we need at the end", "how to get what we need"
        // ** once done "brute forcing" in my mind to understand the problem,
        // focus on "optimizing" each subpart, not "implementing" each subpart.
    }
}
